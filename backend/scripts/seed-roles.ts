...
const sampleBooks = [
  {
    ...
    briefIntro:
      "यह पुस्तक राधास्वामी नाम के महत्व और उसकी महिमा पर प्रकाश डालती है।",
...
- आत्मा की यात्रा और मोक्ष`,
  ...
  },
  {
    ...
    briefIntro:
      "A comprehensive guide to the spiritual teachings and practices of Sant Mat.",
...
सतगुरु की कृपा से ही हम इस भवसागर से पार हो सकते हैं। उनका प्रेम और करुणा हमेशा हमारे साथ रहती है।`,
  ...
  },
  {
    ...
    briefIntro:
      "Practical guidance on meditation practices in the Sant Mat tradition.",
...
const notifications = [
  {
    ...
    message:
      "Welcome to the enhanced RSSB platform with role-based access and meeting features!",
    type: "INFO" as const,
  },
  {
  ...
  try {
    ...
    for (const user of sampleUsers) {
      const createdUser = await prisma.user.create({
        data: {
          ...user,
          createdBy: admin.id, // Admin created these users
        },
      });
    ...
    console.log(
      "   - MENTOR: Can register users, schedule meetings, manage books"
    );
